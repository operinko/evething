...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.show_on_full_list'
        db.add_column(u'thing_userprofile', 'show_on_full_list',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.show_on_full_list'
        db.delete_column(u'thing_userprofile', 'show_on_full_list')
