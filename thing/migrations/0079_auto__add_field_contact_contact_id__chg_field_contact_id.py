...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.contact_id'
        db.add_column(u'thing_contact', 'contact_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Contact.id'
        db.alter_column(u'thing_contact', u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))

    def backwards(self, orm):
        # Deleting field 'Contact.contact_id'
        db.delete_column(u'thing_contact', 'contact_id')


        # Changing field 'Contact.id'
        db.alter_column(u'thing_contact', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
    ...
    models = {
        ...
        u'thing.contact': {
            ...
            'character': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['thing.Character']"}),
            'contact_id': ('django.db.models.fields.IntegerField', [], {'default': "''"}),
            'contact_name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'standing': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '3'})
        },
        u'thing.contract': {
