...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.contact_who'
        db.add_column(u'thing_contact', 'contact_who',
                      self.gf('django.db.models.fields.CharField')(default='pilot', max_length=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.contact_who'
        db.delete_column(u'thing_contact', 'contact_who')
