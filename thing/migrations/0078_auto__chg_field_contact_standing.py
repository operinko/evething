...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.standing'
        db.alter_column(u'thing_contact', 'standing', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'Contact.standing'
        db.alter_column(u'thing_contact', 'standing', self.gf('django.db.models.fields.SmallIntegerField')())
