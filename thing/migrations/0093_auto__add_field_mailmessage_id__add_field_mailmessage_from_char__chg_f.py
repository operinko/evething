...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
      print "yay"
        # Removing unique constraint on 'MailMessage', fields ['message_id']
        #db.delete_unique(u'thing_mailmessage', ['message_id'])

        # Adding field 'MailMessage.id'
        #db.add_column(u'thing_mailmessage', 'id',
        #              self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True),
        #              keep_default=False)

        # Adding field 'MailMessage.from_char'
        #db.add_column(u'thing_mailmessage', 'from_char',
        #              self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='from_char', to=orm['thing.Character']),
        #              keep_default=False)


        # Changing field 'MailMessage.message_id'
        #db.alter_column(u'thing_mailmessage', 'message_id', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):
      print "yeyee"
        # Deleting field 'MailMessage.id'
        #db.delete_column(u'thing_mailmessage', 'id')

        # Deleting field 'MailMessage.from_char'
        #db.delete_column(u'thing_mailmessage', 'from_char_id')


        # Changing field 'MailMessage.message_id'
        #db.alter_column(u'thing_mailmessage', 'message_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
        # Adding unique constraint on 'MailMessage', fields ['message_id']
        #db.create_unique(u'thing_mailmessage', ['message_id'])
    ...
    models = {
        ...
        u'thing.contact': {
            'Meta': {'ordering': "('-standing',)", 'object_name': 'Contact'},
            'character': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['thing.Character']"}),
            'contact_class': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'contact_id': ('django.db.models.fields.IntegerField', [], {}),
            'contact_name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'contact_type': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            'contact_who': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
            'id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
        ...
        u'thing.mailbody': {
            ...
            'message': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'mailbody'", 'unique': 'True', 'primary_key': 'True', 'to': u"orm['thing.MailMessage']"})
        },
        u'thing.mailmessage': {
            'Meta': {'ordering': "('-sent_date',)", 'object_name': 'MailMessage'},
            'from_char': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'from_char'", 'to': u"orm['thing.Character']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message_id': ('django.db.models.fields.IntegerField', [], {}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sender'", 'to': u"orm['thing.Character']"}),
            'sent_date': ('django.db.models.fields.DateTimeField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'to_characters': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'to_corp_or_ally_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'to_lists': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        u'thing.marketgroup': {
        ...
        u'thing.skill': {
            ...
            'parents': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'children'", 'to': u"orm['thing.Skill']", 'through': u"orm['thing.SkillParent']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
        ...
        u'thing.skillparent': {
            ...
            'child_skill': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'parent_skill'", 'to': u"orm['thing.Skill']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'level': ('django.db.models.fields.SmallIntegerField', [], {}),
            'parent_skill': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'child_skill'", 'to': u"orm['thing.Skill']"})
        },
        u'thing.skillplan': {
        ...
        u'thing.userprofile': {
            ...
            'show_on_full_list': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
