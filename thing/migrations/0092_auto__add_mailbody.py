...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MailBody'
        db.create_table(u'thing_mailbody', (
            ('message', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['thing.MailMessage'], unique=True, primary_key=True)),
            ('body', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'thing', ['MailBody'])


    def backwards(self, orm):
        # Deleting model 'MailBody'
        db.delete_table(u'thing_mailbody')
    ...
    models = {
        ...
        u'thing.mailbody': {
            ...
            'message': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['thing.MailMessage']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'thing.mailmessage': {
