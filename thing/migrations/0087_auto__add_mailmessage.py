...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'thing_mailmessage', (
            ('message_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('sender_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Character'])),
            ('sent_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('to_corp_or_ally_id', self.gf('django.db.models.fields.IntegerField')()),
            ('to_characters', self.gf('django.db.models.fields.TextField')()),
            ('to_lists', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'thing', ['MailMessage'])
    ...
    models = {
        ...
        u'thing.mailmessage': {
            ...
            'to_characters': ('django.db.models.fields.TextField', [], {}),
            'to_corp_or_ally_id': ('django.db.models.fields.IntegerField', [], {}),
            'to_lists': ('django.db.models.fields.TextField', [], {})
        },
        u'thing.marketgroup': {
