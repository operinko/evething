...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MailMessage.to_lists'
        db.alter_column(u'thing_mailmessage', 'to_lists', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'MailMessage.to_characters'
        db.alter_column(u'thing_mailmessage', 'to_characters', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'MailMessage.to_corp_or_ally_id'
        db.alter_column(u'thing_mailmessage', 'to_corp_or_ally_id', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'MailMessage.to_lists'
        raise RuntimeError("Cannot reverse this migration. 'MailMessage.to_lists' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MailMessage.to_characters'
        raise RuntimeError("Cannot reverse this migration. 'MailMessage.to_characters' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MailMessage.to_corp_or_ally_id'
        raise RuntimeError("Cannot reverse this migration. 'MailMessage.to_corp_or_ally_id' and its values cannot be restored.")
    ...
    models = {
        ...
        u'thing.mailmessage': {
            ...
            'message_id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
            'sender_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['thing.Character']"}),
            ...
            'to_corp_or_ally_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
