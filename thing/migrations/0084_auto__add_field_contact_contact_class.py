...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.contact_class'
        db.add_column(u'thing_contact', 'contact_class',
                      self.gf('django.db.models.fields.CharField')(default='standing-neutral', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.contact_class'
        db.delete_column(u'thing_contact', 'contact_class')
