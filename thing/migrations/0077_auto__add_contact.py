...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'thing_contact', (
            ...
            ('standing', self.gf('django.db.models.fields.SmallIntegerField')()),
        ))
        db.send_create_signal(u'thing', ['Contact'])


    def backwards(self, orm):
        # Deleting model 'Contact'
        db.delete_table(u'thing_contact')
    ...
    models = {
        ...
        u'thing.contact': {
            ...
            'id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
            'standing': ('django.db.models.fields.SmallIntegerField', [], {})
        },
        u'thing.contract': {
