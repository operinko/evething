...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MailMessage.sender_id'
        db.delete_column(u'thing_mailmessage', 'sender_id_id')

        # Adding field 'MailMessage.sender'
        db.add_column(u'thing_mailmessage', 'sender',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['thing.Character']),
                      keep_default=False)


    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'MailMessage.sender_id'
        raise RuntimeError("Cannot reverse this migration. 'MailMessage.sender_id' and its values cannot be restored.")
        # Deleting field 'MailMessage.sender'
        db.delete_column(u'thing_mailmessage', 'sender_id')
    ...
    models = {
        ...
        u'thing.mailmessage': {
            ...
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['thing.Character']"}),
